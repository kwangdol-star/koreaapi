...
mkdir -p data
if uv run python -c "import urllib.request,os;urllib.request.urlretrieve(os.environ.get('KOREAAPI_DATA_URL','https://kwangdol-star.github.io/koreaapi/latest.json'),'data/latest.json')"; then
